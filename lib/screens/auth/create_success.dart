...
class CreateAccountSuccess extends StatefulWidget {
  const CreateAccountSuccess({Key? key}) : super(key: key);
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          TextApp(text: AppLocalizations.of(context)!.congratulations, color: Color(0xff0D0E56), fontSize: 15, fontWeight: FontWeight.w700,),
          SizedBox(height: SizeConfig.scaleHeight(12),),
          TextApp(text: AppLocalizations.of(context)!.you_have_registered, color: Color(0xff7B7C98), fontSize: 15, fontWeight: FontWeight.w400,),
